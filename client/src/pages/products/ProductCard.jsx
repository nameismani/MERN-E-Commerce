    ...
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg shaodw dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        <div className="flex justify-between">
          <h5 className="mb-2 text-xlt text-white text-wrap">{p?.name}</h5>

          <p className="ms-2 font-semibold text-pink-500">{formattedPrice}</p>
        </div>
        ...
        <section className="flex justify-between items-center">
          ...
          <button
            className="p-2 rounded-full text-whtie"
