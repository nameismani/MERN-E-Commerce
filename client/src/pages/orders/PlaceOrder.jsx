                  ...
                  <tr key={index}>
                    ...
                    <td className="p-2">
                      {item.price.toLocaleString("en-IN", {
                        ...
                        // Specify the currency code for Indian Rupees
                      })}
                    </td>
                    <td className="p-2">
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-between flex-wrap p-8 bg-[#181818] text-white">
            <ul className="text-lg">
              <li>
                <span className="font-semibold mb-4 me-1">Items:</span>
              ...
              <li>
                <span className="font-semibold mb-4 me-1">Shipping:</span>
              ...
              <li>
                <span className="font-semibold mb-4 me-1">Tax:</span>
              ...
              <li>
                <span className="font-semibold mb-4 me-1">Total:</span>
